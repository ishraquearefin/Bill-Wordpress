    								 ...
    								 <?php if ( get_pages( 'child_of=' . $page->ID) ) {?>
            							...
            							<?php  if (wp_get_post_parent_id(get_the_ID())) {?>
             							...
             							$title = $page->post_title;?>
      									<li class="nav-item dropdown" style="list-style: none; width: 480px"><a class="dropdown-item" href="#" id="navbarDropdown1" role="button">
											<h2 class="host tophost"><?php echo $title?></h2>
										</a>
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown1" id ="main_menu"><?php wp_list_pages("title_li=&child_of=$page->ID" );?>  </ul>
										</li>
                                      <?php } elseif ( is_page() && $post->post_parent ) {?>
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown6" id ="main_menu">
                                         <?php wp_list_pages("title_li=&child_of=$page->ID&list-style=none" );?>
            	...
            	<?php wp_nav_menu(
                    ...
                    array(
                        'theme_location'  => 'top-menu',
                         'depth'           => 2,
                         'container'       => 'ul',
                         'menu_class'      => 'navbar-expand-lg navbar-nav nav-item',
